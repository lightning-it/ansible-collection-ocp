...
# Build and install the collection inside the container-ee-wunder-devtools-ubi9 container.
...
echo "Preparing collection ${ns}.${name} inside container-ee-wunder-devtools-ubi9..."
